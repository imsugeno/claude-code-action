...
**How to use this fork**: https://imsugeno.bearblog.dev/use-claude-github-actions-with-claude-max/
  ...
  claude-code-action:
    ...
    steps:
      ...
      - name: Run Claude PR Action
        uses: imsugeno/claude-code-action@beta
        with:
          use_oauth: true
...
steps:
  - uses: imsugeno/claude-code-action@beta  # Fork with OAuth support
    with:
      direct_prompt: |
